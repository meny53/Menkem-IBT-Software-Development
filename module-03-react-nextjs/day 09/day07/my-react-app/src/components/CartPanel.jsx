...
function CartPanel({ isOpen, onClose }) {
  ...
  // Read from CartContext, fallback to Zustand store
  ...
  // Deliberate error test for the second boundary
  if (shouldCrash) {
  ...
  return (
    ...
    >
      ...
      <div className="cart-panel-footer">
        ...
        {/* Boundary 2 Test: Deliberate Cart Crash button */}
